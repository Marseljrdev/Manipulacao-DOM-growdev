...
function atualizaPagina(count){
    const mostraClick = document.getElementById('exibeClick')

    mostraClick.innerText = '';

    mostraClick.innerHTML = `O contador esta com ${count} cliques`;
